        ...
        <html>
            ...
            <body>
                <div>
                    ...
                    <svg width="100" height="200" viewBox="0 0 512 512">
                      ...
                      <a href="/toggle/0">
                          <circle style="fill:#{red}" cx="255.995" cy="73.755" r="48.281"/>
                      </a>
                      <a href="/toggle/1">
                          <circle style="fill:#{yellow}" cx="255.995" cy="183.755" r="48.281"/>
                      </a>
                      <a href="/toggle/2">
                          <circle style="fill:#{green}" cx="255.995" cy="293.755" r="48.281"/>
                      </a>
                      <a href="/toggle/3">
                          <circle style="fill:#{blue}" cx="255.995" cy="403.755" r="48.281"/>
                      </a>
                    </svg>
                </div>
            </body>
